...
import com.simplysmart.service.adapter.SummaryReadingListAdapterV2;
...
public class TodaySummaryFragmentV2 extends BaseFragment implements EditDialogListener {

    private RecyclerView summary;
    private ArrayList<Summary> summaryList;
    private SummaryListAdapter adapter;

    private ArrayList<MatrixReadingData> readingDataArrayList;
...
//        setDataForSummary();
        ...
        readingDataArrayList = new ArrayList<>();
            ...
            public void onClick(View v) {
                ...
                if (NetworkUtilities.isInternet(getActivity())) {
                    ...
                    for (int i = 0; i < readingDataArrayList.size(); i++) {
                        ...
                        Call<JsonObject> call = apiInterface.submitMatrixReading(readingDataArrayList.get(i));
...
//            header.setName(readingDataArrayList.type);
//            header.setValue(matrixTable.icon);
//            header.setHeader(true);
//            summaryList.add(header);
//
//            for (MatrixReadingData readingTable : readingDataArrayList) {
//                Summary summary = new Summary();
//
//                summary.setName(readingTable.);
...
//        setDataInList();
    ...
    private void setDataInList(ArrayList<MatrixReadingData> readings) {
        ...
        SummaryReadingListAdapterV2 readingListAdapter = new SummaryReadingListAdapterV2(readings, getActivity(), getFragmentManager());
        summary.setLayoutManager(linearLayoutManager);
        summary.setAdapter(readingListAdapter);
        summary.setVisibility(View.VISIBLE);
