...
public class VisitorListAdapter2 extends RecyclerView.Adapter<VisitorListItemViewHolder> {
    private Context mContext;
    private List<VisitorTable> visitorTables;

    public VisitorListAdapter2(Context mContext, List<VisitorTable> visitorTables) {
    ...
    public void onBindViewHolder(VisitorListItemViewHolder holder, int position) {
        ...
        holder.noOfPersons.setText("No of person : "+visitorTable.num_of_person);
        holder.description.setText("Details : "+visitorTable.details);
