...
public class SummaryReadingListAdapterV2 extends RecyclerView.Adapter<ReadingViewHolder> {
    private List<MatrixReadingData> readingsList;
    private Context mContext;
    private FragmentManager fragmentManager;
    private SimpleDateFormat sdf;

    public SummaryReadingListAdapterV2(List<MatrixReadingData> readingsList, Context mContext, FragmentManager fragmentManager) {
