...
public class MainActivity_V2 extends GetLocationBaseActivity implements LogoutListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Menu menuItem = navigationView.getMenu();
        ...
        //Added by Omkar on 18 April 2017
//        String policyForAccess = GlobalData.getInstance().getPolicyAccess();
//        switch (policyForAccess){
//            case
//        }
       // AccessPolicy accessPolicy = GlobalData.getInstance().getAccessPolicy();
        if (GlobalData.getInstance().getAccessPolicy().isHelpdesk()){
            //setContentView(R.layout.activity_help_desk);
//           MenuItem item =  menuItem.getItem(0);
//             getMenuInflater().inflate(R.menu.menu_main, menuItem);
            Log.d("Helpdesk","Helpdesk is true");
        }
//        if (accessPolicy.isHelpdesk()){
//                Log.d("HelpDesk","Helpdesk is true");
//            }
//         if (accessPolicy.isPlanner()){
//            Log.d("Planner","Planner is true");
//        }
//        else
//        {
...
//        }
    ...
    private void setDataInList(List<MatrixTable> list) {
        ...
        RecyclerView.LayoutManager gridLayoutManager = new GridLayoutManager(MainActivity_V2.this, 2);
    ...
    private void getUserInfo() {
        ...
        //GlobalData.getInstance().setPolicyAccess(UserInfo.getString("policy",""));
        ...
        String jsonAccessPolicy = UserInfo.getString("policy", "");
...
//            }
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivity_V2.this, SummaryActivity.class);
                startActivity(i);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.attendance:
                        Intent i = new Intent(MainActivity_V2.this, AttendanceActivity.class);
                        startActivity(i);
                        return true;
                    case R.id.visitors:
                        Intent i2 = new Intent(MainActivity_V2.this, VisitorActivity.class);
                        startActivity(i2);
                        return true;
...
//                        return true;
    ...
    private void setAlarmForNotification() {
        ...
        try {
            ...
            Intent alarmIntent = new Intent(MainActivity_V2.this, AlarmReceiver.class);
            PendingIntent pendingIntent = PendingIntent.getBroadcast(MainActivity_V2.this, 0, alarmIntent, 0);
