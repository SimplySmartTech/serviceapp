...
import com.simplysmart.service.fragment.SensorInfoList;
import com.simplysmart.service.fragment.SensorInfoTodayList;
...
public class SiteSensorsScreenActivity extends BaseActivity implements LogoutListener {
                ...
                if (!isMenuSelected) {
                    ...
                    for (int i = 0; i < navigationView.getMenu().size(); i++) {
                        ...
                        if (item == navigationView.getMenu().getItem(i)) {
                            ...
                            LocalBroadcastManager.getInstance(SiteSensorsScreenActivity.this).sendBroadcast(intent);
                            break;
                        }
                    }
                }
    ...
    private class GetVersionCode extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                newVersion = Jsoup.connect("https://play.google.com/store/apps/details?id=" + SiteSensorsScreenActivity.this.getPackageName() + "&hl=it")
                        .timeout(30000)
